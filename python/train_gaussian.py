...
# Entraînement du modèle de Gaussian Naive Bayes pour le résultat du match
...
joblib.dump(model_cls, 'result_model_gaussiannb.pkl')
joblib.dump(model_home_score, 'home_score_model_ridge.pkl')
joblib.dump(model_away_score, 'away_score_model_ridge.pkl')
