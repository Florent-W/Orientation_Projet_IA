...
# Entraînement du modèle d'arbre de décision pour le résultat du match
...
# Entraînement des modèles d'arbre de décision pour les scores
model_home_score = DecisionTreeRegressor()
model_away_score = DecisionTreeRegressor()
...
joblib.dump(model_cls, 'result_model_tree.pkl')
joblib.dump(model_home_score, 'home_score_model_tree.pkl')
joblib.dump(model_away_score, 'away_score_model_tree.pkl')
