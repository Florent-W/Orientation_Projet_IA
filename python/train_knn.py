...
# Entraînement du modèle KNN pour le résultat du match
...
# Entraînement des modèles KNN pour les scores
model_home_score = KNeighborsRegressor(n_neighbors=5)
model_away_score = KNeighborsRegressor(n_neighbors=5)
...
joblib.dump(model_cls, 'result_model_knn.pkl')
joblib.dump(model_home_score, 'home_score_model_knn.pkl')
joblib.dump(model_away_score, 'away_score_model_knn.pkl')
joblib.dump(scaler_cls, 'scaler_cls_knn.pkl')
joblib.dump(scaler_reg_home, 'scaler_reg_home_knn.pkl')
joblib.dump(scaler_reg_away, 'scaler_reg_away_knn.pkl')
joblib.dump(features_encoded.columns, 'features_knn.pkl')
