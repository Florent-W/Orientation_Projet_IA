...
joblib.dump(model_cls, 'models/result_model.pkl')
joblib.dump(model_home_score, 'models/home_score_model.pkl')
joblib.dump(model_away_score, 'models/away_score_model.pkl')
joblib.dump(scaler_cls, 'scalers/scaler_cls.pkl')
joblib.dump(scaler_reg_home, 'scalers/scaler_reg_home.pkl')
joblib.dump(scaler_reg_away, 'scalers/scaler_reg_away.pkl')
joblib.dump(features_encoded.columns, 'models/features.pkl')
